      ...
      <WithTooltip tooltipProps={tooltipProps} hoverStyles={null} renderTooltip={renderTooltip}>
        {({ onMouseLeave, onMouseMove, tooltipData }: TooltipProps) => (
          <div>
            ...
            <div style={{ height: '30px', fontSize: 10 }}>
              <div style={{ width: width, zIndex: 1, position: 'relative', top: -25 }}>
                <div style={{ display: 'inline-block', width: '33.3%', paddingLeft: 5 }}>
                  <div>|</div>
