...
export default function DataTable<D extends object>({
  ...
  //   const renderTableData = (cells: any) => {
  ...
  //     //    )
  //     // })
  //     const result = (cells.map( (cell: any) =>  <td>{cell.value.toString()}</td>));
  //     // console.log('result',  result );
  //     // const result2 = (<div><td>aaaa</td><td>aaaa</td><td>aaaa</td><td>aaaa</td><td>aaaa</td></div>)  ;
  //     // console.log('result2', result2) ;

  //     // const result3 = React.createElement('div', null, result) ;
          ...
          page.map(row => {
            ...
            return (
              <tr key={rowKey || row.id} {...rowProps}>
                ...
                {/* {row.cells.map( (cell) =>  {return <td>{cell.value}</td> } ) } */}
                {/* <>{ renderTableData( row.cells) }</> */}
              </tr>
            );
          })
        ) : (
