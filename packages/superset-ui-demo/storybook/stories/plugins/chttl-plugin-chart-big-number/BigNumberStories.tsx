...
// import { BigNumberChartPlugin } from '@chttl/legacy-preset-chart-big-number';
import testData from './data';

new ChttlBigNumberChartPlugin().configure({ key: 'chttl-big-number' }).register();
...
export default {
  title: 'CHTTL Plugins|BigNumber',
};

export const basicWithTrendline = () => (
  <SuperChart
    chartType="chttl-big-number"
    width={400}
    height={400}
